                       ...
                       @foreach ($category as $list )
                        ...
                        <td><div class="" style="display: flex; justify-content:center; gap:10px " >
                            ...
                            <div class="education__item-details">
                                <form action="{{route('category.update', ['id' =>$list->id])}}" method="post">
                                    @csrf 
                                    @method('post')  
                                <h3 class="education__title">Category</h3>
                                ...
                                <div class="input__education">
                                    <input type="text" class="input_educations" name="description" placeholder="{{$list->description}}" value="{{$list->description}}">
    ...
    <div class="education__popup-inner">
        <div class="education__popup-content grid">
            ...
            <div class="education__popup-info">
                <div class="education__popup-subtitle">Update - <span>Category</span></div>
...
<div class="educations__modal">
    <div class="educations__modal-content">
        ...
        <div class="contact__content">
            <form action="{{route('category.add')}}" class="contact-form" method="post">
                @csrf 
                @method('post')  
                <h3 class="services__modal-title">Category Name</h3>
